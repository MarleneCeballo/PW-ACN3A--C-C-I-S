...
<ol>
    ...
    <?php 
        $sql = "INSERT INTO zapatillas(id_marca,nombre,descripcion,precio,modelo,id_genero,imagenmini,imagengrande,nuevo) 
                       VALUES ('1','Zapatilla Rosa Adidas Entrap','',6799,'Entrap','2','inc/img/adidasmujer/adidas-rosa-entrap-mini.jpg','inc/img/adidasmujer/adidas-rosa-entrap-grande.jpg','si');
		//echo $sql;
       $count = $con->exec($sql);
	   if($count > 0 ) 
    ...
    <?php 
        ...
        $apellido = 'Serrano';
        $email = "hs@mail.com";  
        $cmd = $con->prepare("INSERT INTO alumnos(nombre,apellido,email) VALUES(?,?,?)");
    ...
    <?php  
        $proc = $con->prepare("CALL mostrar_alumnoss()");
